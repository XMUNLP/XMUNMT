...
def batch_examples(example, batch_size, max_length, mantissa_bits,
    ...
    """ Batch examples
    Args:
        example: A dictionary of <feature name, Tensor>.
        batch_size: The number of tokens or sentences in a batch
        max_length: The maximum length of a example to keep
        mantissa_bits: An integer
        shard_multiplier: an integer increasing the batch_size to suit
            splitting across data shards.
        length_multiplier: an integer multiplier that is used to
            increase the batch sizes and sequence length tolerance.
        constant: Whether to use constant batch size
        num_threads: Number of threads
        drop_long_sequences: Whether to drop long sequences

    Returns:
        A dictionary of batched examples
    """
